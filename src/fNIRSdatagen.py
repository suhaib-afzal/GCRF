...
class fNIRSSignalGenerator(channelLocationMap):
	...
	def addExperimentalNoise(self, channelsList=list(), initSample=0, endSample=-1):
		...
		nSamples = endSample - initSample
		self.__data[0:nSamples,channelsList,:] = self.__data[0:nSamples,channelsList,:] + 0.00001*d
		
	#end addExperimentalNoise


	def execute(self, boxcar_amp = [1], channel_amp=[1]):
		'''
		...
		#boxCarList_OnsetDurations = [(35, 20), (105, 20), (175, 20), (240, 20)]
		...
		#self.addExperimentalNoise(channelsList, initSample=0, endSample=-1)

		plotSyntheticfNIRS(self.data, title='Synthetic fNIRS + All Noise', enableHbO2Channels=enableHbO2Channels, enableHHbChannels=enableHHbChannels)
